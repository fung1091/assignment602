...
trade <-data.frame("Side"=character(), "Ticker"=character(), "Quantity"=integer(0), "Price"=integer(0), "Date"=integer(),stringsAsFactors = FALSE)
...
x[nrow(x) +1,] <- c(nrow(x)+1,'buy', 'amzn', 30, 1000.46, Sys.Date())
x[nrow(x) +1,] <- c(nrow(x)+1,'sell', 'amzn', 15, 1100.00, Sys.Date())
